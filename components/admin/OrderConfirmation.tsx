                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="flex items-center justify-end gap-3">
                        ...
                        <button
                            ...
                            className="px-6 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-[#3D518C] to-[#5C6BC0] hover:from-[#2D4178] hover:to-[#4C5BB0] rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5"
                        >
                            Save Changes
                        </button>
                    </div>
