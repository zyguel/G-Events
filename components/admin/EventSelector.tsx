...
export default function EventSelector({ events, currentEventId, selectedYear, onYearChange }: EventSelectorProps) {
    ...
    return (
        <div className="flex items-center gap-2">
            ...
            {/* Clear Filter Button - always visible next to year filter */}
            <button
